...
PACKAGES=("./tests/csapi" "./tests" "./tests/msc4306" "./tests/msc4222" "./tests/msc3967" "./tests/msc3874" "./tests/msc3391" "./tests/msc3890" "./tests/msc3930" "./tests/msc4155" "./tests/msc3757" "./tests/msc2836" "./tests/msc4140")
if [ $# -gt 0 ]; then
    PACKAGES=("$@")
fi
