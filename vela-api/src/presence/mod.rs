//! Presence: state machine + auto-decay sweeper. This file owns
//! `/presence/{userId}/status` (get + put); `presence_sweeper` runs
//! the background idle→unavailable→offline transitions.
//!
