//! User-visible identity surface: profile, OpenID issuance, and the
//! per-server `/capabilities` introspection endpoint.
...
fn federation_profile_err(
    e: crate::federation::federation_client::FederationClientError,
) -> ApiError {
