//! Operator surfaces: the admin bot (this file) and abuse-report
//! consumption (`report`). The bot dispatch lives here because the
//! admin-room state and `!command` parsing is one cohesive unit.
//!
